...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  if(isset($_GET['error'])) {
    ...
    if($_GET['error'] == 1){
      ...
      echo '<div class="alert alert-dismissible alert-danger">
        <strong>Error!</strong></strong> debe escoger una categoría y un estado para el foro.
      </div>';
    }
...
<div class="row container">
   <div class="pull-right">
     <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
       ...
       <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
           <a class="mbr-buttons__btn btn btn-danger active" href="?view=configforos&mode=agregar">CREAR FOROS</a>
       </li></ul></div>
     </div>
...
<div class="row categorias_con_foros">
  <div class="col-sm-12">
      ...
      <div class="row cajas">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=configforos&mode=agregar" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="nombre" class="col-lg-2 control-label">Nombre:</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" name="nombre" placeholder="Nombre para el foro">
                </div>
