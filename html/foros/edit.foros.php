...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  if(isset($_GET['success'])) {
    echo '<div class="alert alert-dismissible alert-success">
      <strong>Compleato!</strong> el foro ha sido editado.
    </div>';
  }
  if(isset($_GET['error'])) {
    echo '<div class="alert alert-dismissible alert-danger">
      <strong>Error!</strong></strong> ningún campo puede quedar vacíos.
    </div>';
  }
  ?>
...
<div class="row container">
   <div class="pull-right">
    ...
    <ol class="breadcrumb">
      <li><a href="?view=index"><i class="fa fa-tags"></i>Foros</a></li>
    </ol>
</div>

<div class="row categorias_con_foros">
  <div class="col-sm-12">
      <div class="row titulo_categoria">Editado de Foros</div>

      <div class="row cajas">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=configforos&mode=editar&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Nombre:</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="nombre" placeholder="Nombre para el foro" value="<?php echo $foros[$_GET['id']-1]['nombre']; ?>">
                </div>
                <label for="inputEmail" class="col-lg-2 control-label">Descripción:</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="descripcion" placeholder="Nombre para el foro" value="<?php echo $foros[$_GET['id']-1]['descripcion']; ?>">
                </div>
                <label for="select" class="col-lg-2 control-label">Categoría:</label>
                <div class="col-lg-10">
                  <select class="form-control" name="categorias" >

                <!--___________FOREACH PARA LAS CATEGORÍAS___________-->
                    <?php
                      if(false != $categoria){
