...
<div class="row container">
    ...
    <ol class="breadcrumb">
      <li><a href="?view=index"><i class="fa fa-tags"></i>Tema nuevo</a></li>
    </ol>
</div>

<div class="row categorias_con_foros">
  <div class="col-sm-12">
      <div class="row titulo_categoria">Creación de tema nuevo en "<?php echo $foros[$id_foro]['nombre'];  ?>"</div>

      <div class="row cajas">
        <div class="col-md-9">
          <form class="form-horizontal" action="?view=temas&mode=crear&id_foro=<?php echo $id_foro; ?>" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="nombre" class="col-lg-2 control-label">Título:</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" name="titulo" placeholder="Nombre para el tema">
                </div>
                <label for="descripcion" class="col-lg-2 control-label">Contenido:</label>
                <div class="col-lg-10">
                  <textarea class="form-control tema_textarea" name="contenido" placeholder="Contenido de tu tema, se acepta BBCode"></textarea>
                  </textarea>
                </div>

              </div>

                  <!-- SI EL USUARIO ES MODERADOR O ADMINISTRADOR, ENTONCES PUEDE HACER ANUNCIOS -->
              <?php if($usuarios[$_SESSION['app_id']]['permisos'] > 0){

                    echo '<div class="form-group">
                      <div class="col-lg-10">
                        <label class="col-lg-4 control-label"><input type="checkbox" value="2" name="anuncio">Crear tema como anuncio</label>
                      </div>
                    </div>';
                  }
              ?>
