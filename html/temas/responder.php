  ...
  if(isset($_GET['error'])) {
    ...
    if($_GET['error'] == 1){
      echo '<div class="alert alert-dismissible alert-danger">
        <strong>Error!</strong></strong> El contenido de la respuesta no puede estar vacío.
      </div>';
    }
    else {
      echo '<div class="alert alert-dismissible alert-danger">
        <strong>Error!</strong></strong> No se pudo enviar la respuesta. 
      </div>';
    }
...
<div class="row container">
    ...
    <ol class="breadcrumb">
      <li><i class="fa fa-tags"></i>Responder tema</li>
    </ol>
</div>

<div class="row categorias_con_foros">
  <div class="col-sm-12">
      <div class="row titulo_categoria">Respuesta al tema "<?php echo $resul_temas['titulo'];  ?>"</div>
          ...
          <form class="form-horizontal" action="?view=temas&mode=responder&id_foro=<?php echo $id_foro; ?>&id=<?php echo $_GET['id']; ?>" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <textarea class="form-control tema_textarea" name="contenido" placeholder="Contenido de tu respuesta, se acepta BBCode" required></textarea>
                </div>
